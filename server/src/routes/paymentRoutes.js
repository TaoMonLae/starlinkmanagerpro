...
import { createPayment, getPaymentReceipt, listPayments, markPaid, updatePayment } from "../controllers/paymentController.js";
...
paymentRoutes.put("/:id", validate(paymentSchema), asyncHandler(updatePayment));
